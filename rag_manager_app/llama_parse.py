...
documents = SimpleDirectoryReader(input_files=[r"C:\Users\134\saved_pages\ELTIS_site\download\reh-eltis-dpu5000-kedc-setevoj.pdf"], file_extractor=file_extractor).load_data()
print(documents)


output_folder = r"C:\Users\134\Documents\for_Llama_index"
